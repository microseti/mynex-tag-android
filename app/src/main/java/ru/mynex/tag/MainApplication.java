...
public class MainApplication extends Application {
    ...
    public void onCreate() {
        ...
        Log.d("ru.mynex.tag - ", "========== START PROGRAM ========");
    ...
    private void migrateLegacyPreferences(SharedPreferences preferences) {
        ...
        if (port != null) {
            String host = preferences.getString("address", getString(R.string.settings_saddr_default_value));
            Uri.Builder builder = new Uri.Builder();
            builder.encodedAuthority(host + ":" + port).build();
            SharedPreferences.Editor editor = preferences.edit();
            editor.putString(MainFragment.KEY_SADDR, builder.toString());
